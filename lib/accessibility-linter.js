...
import { attributes, roles } from 'aria-config';
import consoleReporter from './reporters/console';
import * as observers from './observers';
import Rule from './rule';
import XPathRule from './rules/xpath-rule';
import AriaRule from './rules/aria-rule';
...
AccessibilityLinter.AriaRule = AriaRule;
...
AccessibilityLinter.config = { attributes, roles };
